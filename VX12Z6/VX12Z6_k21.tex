...
A vizsgált folyamat $p = {\textit{állandó}}$ nyomáson megy végbe, ezért az első főtétel megfelelő alakja alapján  azt kapjuk, hogy:
...
\begin{figure}[h]
	...
	ytick={100, 200, 300, 400, 500}
		...
		\addplot[thick, black] table {./VX12Z6/ts_p981.txt};
		\addplot[ultra thick, blue, mid arrow=blue] table {./VX12Z6/ts_p981_2.txt};
		...
		%Sraffozás
		\addplot[opacity=0, name path=A, domain=0.5047:7.47, samples=25] table {./VX12Z6/ts_p981_2.txt};
		...
		%nyomás görbe jelölése
		\node[black, rotate = 80] at (axis cs:7.48, 460) {\SI{9,81}{\bar}};
