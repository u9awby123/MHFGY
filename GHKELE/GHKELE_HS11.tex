...
\end{equation}
A víz hőmérséklete figyelembe véve az előjelet $\SI{0,01425}{\celsios}$ fokot hűl óránként. 
\begin{figure}[h]
	\centering
	\begin{tikzpicture}
	...
	\end{tikzpicture}
	\caption{ Gömbalakú víztartály vázlata}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{./GHKELE/HS11V}
	\caption{ Gömbalakú víztartály hőmérséklet-helyfüggvénye }
	\label{Gömbalakú víztartály}
\end{figure}