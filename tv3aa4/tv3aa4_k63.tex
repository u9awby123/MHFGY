...
\addcontentsline{toc}{section}{K6/3. feladat: Hőátadási tényező számítása}
	...
	\noindent
	15 °C-os víz áramlik a $d$=0,015m átmérőjű, $L$=0,5 m hosszú csőben. A közepes áramlási sebesség $w$=0,1 m/s. A cső belső falának hőmérséklete $t_w$ =50 °C. Számítsa ki a hőátadási tényező értéket!
	\\ \\
	Hausensen képlet:
