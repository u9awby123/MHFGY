...
\section*{K5/1. feladat}
\addcontentsline{toc}{section}{K5/1. feladat}
Egy kazánban \SI{10}{\bar} nyomású gőzt termelnek. A kazánfal belső felülete \SI{200}{\celsius}, külső (tűztér felőli) felülete pedig \SI{395}{\celsius} hőmérsékletű. A kazán fala $\delta_1 = \SI{16}{\milli\meter}$ vastagságú.
...
\begin{figure}[h]
	\begin{subfigure}[b]{0.32\textwidth} 
		...
		\begin{tikzpicture}
			...
			\draw[->] (-1.25,0) -- (4.25,0) node[anchor=base east, shift={(0,-0.5)}]{$x$};
