...
% Ábrázolás: izobár p-V diagram (adatok az "idealisgaz_pV_Ts.xlsx" táblázat első "pVa" nevű oldaláról)

% A számításhoz használt egyenlet: V=RTn/p  
...
%	extra y tick labels={$p_K$}
	...
	\addplot[thick] table {./nw3wyw/pV_a/pvat1.txt};
		\node[anchor=north east] at (axis cs: 0.11, 750) {$T_1$};
	
	\addplot[thick] table {./nw3wyw/pV_a/pvat2.txt};
...
% Ábrázolás: izobár T-S diagram 
% (adatok az "idealisgaz_pV_TS.xlsx" táblázat negyedik "TSb" nevű oldaláról)

% A számításhoz használt egyenlet: 
%dS=n(cp)ln(T2/T1)+nRln(V2/V1)
...
% Ábrázolás: izochor p-V diagram 
% (adatok az "idealisgaz_pV_Ts.xlsx" táblázat harmadik "pVb" nevű oldaláról)
% A számításhoz használt egyenlet: V=RTn/p
...
\begin{figure}[h]
	...
	\addplot[thick] table {./nw3wyw/pV_b/pvbt1.txt};
	\node[anchor=south west] at (axis cs: 0.1, 600) {$T_1$};
	
	\addplot[thick] table {./nw3wyw/pV_b/pvbt2.txt};
...
% Ábrázolás: izobár T-S diagram 
% (adatok az "idealisgaz_pV_TS.xlsx" táblázat második "TSa" nevű oldaláról)
