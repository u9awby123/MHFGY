...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{0.45\textwidth} 
		...
		\begin{tikzpicture}
			...
			\pgfmathsetmacro{\L}{5}
			\pgfmathsetmacro{\TA}{126.43/160*4}
			...
			\draw[->, ultra thick] (0.5,{\L+0.35}) -- ({\d/2},{\L+0.35}) node[anchor=south]{$\dot{q}_1$} -- ({\d - 0.5},{\L+0.35});
		...
		\end{tikzpicture}
		\caption{A hőmérséklet-hely függvény az A) esetben, vízkő réteg nélkül}
	\end{subfigure}
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\begin{tikzpicture}
			...
			\pgfmathsetmacro{\L}{5}
			\pgfmathsetmacro{\TA}{126.43/160*4.2}
			\pgfmathsetmacro{\TB}{118.93/160*1.2}
			...
			% Hőáram és hőáramsűrűség
			\draw[->, ultra thick] (0.5,{\L+0.35}) -- ({\d/2},{\L+0.35}) node[anchor=south]{$\dot{q}_1 = \dot{q}_2$} -- ({\d - 0.5},{\L+0.35});
		...
		\end{tikzpicture}
		\caption{A hőmérséklet-hely függvény vízkő réteg esetén.}
	\end{subfigure}
